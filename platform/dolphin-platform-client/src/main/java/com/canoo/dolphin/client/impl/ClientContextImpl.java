...
public class ClientContextImpl implements ClientContext {
    ...
    public ClientContextImpl(ClientConfiguration clientConfiguration, ClientDolphin clientDolphin, final HttpClient httpClient, ControllerProxyFactory controllerProxyFactory, DolphinCommandHandler dolphinCommandHandler, ClientPlatformBeanRepository platformBeanRepository, ClientBeanManagerImpl clientBeanManager, ForwardableCallback<DolphinRemotingException> remotingErrorHandler) throws ExecutionException, InterruptedException {
